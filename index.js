...
function simpleRant() {
    ...
    dic_country = dic_country.concat(dic_country_mediterranean,dic_country_caribbean,dic_country_oceania,dic_country_eurasia,dic_country_africa,
        dic_country_middleeast,dic_country_southamerica,dic_country_asia,dic_country_europe,
        dic_country_northamerica,dic_country_centralamerica).makeUnique();
