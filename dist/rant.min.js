dic.celeb.songwriter=["50 Cent/50/Cent","Will Smith/Will/Smith","Eminem/Marshall/Mathers","Rihanna/Robyn/Fenty","Slash/Saul/Hudson","Axl Rose/Axl/Rose","Duff McKagan/Duff/McKagan","Marilyn Manson/Brian/Warner","Trent Reznor/Trent/Reznor","Serj Tankian/Serj/Tankian","David Lee Roth/David/Roth","Eddie Van Halen/Edward/Van Halen"];
dic.celeb.rapper=["Will Smith/Will/Smith","Eminem/Marshall/Mathers","John Cena/John/Cena"];
dic.celeb.director=["Natalie Portman/Natalie/Portman","Shia LaBeouf/Shia/LaBeouf","Woody Allen/Woody/Allen","Lena Dunham/Lena/Dunham"];
dic.celeb.comedian=["Adam Sandler/Adam/Sandler","Will Ferrell/Will/Ferrell","Robin Willians/Robin/Williams","Bill Murray/Bill/Murray","Woody Allen/Woody/Allen","Jack Black/Jack/Black","Ben Stein/Ben/Stein","Ben Stiller/Ben/Stiller"];
dic.celeb.writer=["Will Ferrell/Will/Ferrell","John Travolta/John/Travolta","Woody Allen/Woody/Allen","Lena Dunham/Lena/Dunham","Ben Stein/Ben/Stein"];
dic.celeb.hindu=["Julia Roberts/Julia/Roberts"];
dic.celeb.meme=["Shia LaBeouf/Shia/LaBeouf","John Cena/John/Cena"];
dic.celeb.dancer=["John Travolta/John/Travolta","Channing Tatum/Channing/Tatum"];
dic.celeb.wrestler=["John Cena/John/Cena"];
dic.celeb.playwright=["Woody Allen/Woody/Allen","Jesse Eisenberg/Jesse/Eosenberg"];
dic.celeb.guitarist=["Slash/Saul/Hudson","Eddie Van Halen/Edward/Van Halen"];
dic.celeb.columnist=["Duff McKagan/Duff/McKagan"];
dic.celeb.author=["Duff McKagan/Duff/McKagan","Jesse Eisenberg/Jesse/Eosenberg","Ben Stein/Ben/Stein"];
dic.celeb.painter=["Marilyn Manson/Brian/Warner","Serj Tankian/Serj/Tankian"];
dic.celeb.artist=["Marilyn Manson/Brian/Warner","Serj Tankian/Serj/Tankian"];
dic.celeb.journalist=["Marilyn Manson/Brian/Warner"];
dic.celeb.composer=["Trent Reznor/Trent/Reznor","Serj Tankian/Serj/Tankian"];
dic.celeb.armenian=["Serj Tankian/Serj/Tankian"];
dic.celeb.poet=["Serj Tankian/Serj/Tankian"];
dic.celeb.businessman=["Donald Trump/Donald/Trump"];
dic.celeb.politician=["Donald Trump/Donald/Trump","Hillary Clinton/Hillary/Clinton","Bernie Sanders/Bernie/Sanders"];
dic.celeb.dj=["Danny Masterson/Daniel/Masterson"];
dic.celeb.lawyer=["Ben Stein/Ben/Stein"];
dic.celeb.all=[].concat(dic.celeb.male,dic.celeb.austrian,dic.celeb.actor,dic.celeb.republican,dic.celeb.governor,dic.celeb.british,dic.celeb.jewish,dic.celeb.american,dic.celeb.producer,dic.celeb.scientologist,dic.celeb.australian,dic.celeb.singer,dic.celeb.female,dic.celeb.model,dic.celeb.activist,dic.celeb.canadian,dic.celeb.musician,dic.celeb.songwriter,dic.celeb.rapper,dic.celeb.director,dic.celeb.comedian,dic.celeb.writer,dic.celeb.hindu,dic.celeb.meme,dic.celeb.dancer,dic.celeb.wrestler,dic.celeb.playwright,dic.celeb.guitarist,dic.celeb.columnist,dic.celeb.author,dic.celeb.painter,dic.celeb.artist,dic.celeb.journalist,dic.celeb.composer,dic.celeb.armenian,dic.celeb.poet,dic.celeb.businessman,dic.celeb.politician,dic.celeb.dj,dic.celeb.lawyer);
dic.celeb.subs=["full","first","last"];
dic.celeb.filters=["male","austrian","actor","republican","governor","british","jewish","american","producer","scientologist","australian","singer","female","model","activist","canadian","musician","songwriter","rapper","director","comedian","writer","hindu","meme","dancer","wrestler","playwright","guitarist","columnist","author","painter","artist","journalist","composer","armenian","poet","businessman","politician","dj","lawyer"];
var color={};
dic.color=color;
...
var disease={};
dic.disease=disease;
dic.disease.infectious=["chicken pox","ebola","Hepatitis A","Hepatitis B","influenza","smallpox","pinkeye","plague","strep throat"];
dic.disease.viral=["chicken pox","ebola","Hepatitis A","Hepatitis B","influenza","smallpox"];
dic.disease.std=["herpes","AIDS"];
dic.disease.bacterial=["strep throat"];
dic.disease.fever=["typhoid fever"];
dic.disease.mental=["Alzheimer's","amnesia","autism","bipolar disorder","dementia","depression","dissociative identity disorder","mental retardation","schizophrenia"];
dic.disease.genetic=["Down syndrome","albinism"];
dic.disease.inflammatory=["anaphylaxis"];
dic.disease.gi=["appendicitis","diarrhea","gastroenteritis"];
dic.disease.poisoning=["arsenic poisoning","lead poisoning","mercury poisoning"];
dic.disease.fungal=["athlete's foot"];
dic.disease.endocrine=["hyperthyroidism","hypothyroidism"];
dic.disease.autoimmune=["type I diabetes"];
dic.disease.diabetes=["type I diabetes","type II diabetes"];
dic.disease.all=["acute inclusion body encephalitis","alveolitis","anal sacculitis","arthritis","bronchitis","deep vein thrombosis","delirium","epilepsy","fibrosis","folliculitis","halitosis","laryngitis","lupus","meningitis","osteoporosis","rheumatoid arthritis","sacculitis","tetanus","tonsilitis"].concat(dic.disease.infectious,dic.disease.viral,dic.disease.std,dic.disease.bacterial,dic.disease.fever,dic.disease.mental,dic.disease.genetic,dic.disease.inflammatory,dic.disease.gi,dic.disease.poisoning,dic.disease.fungal,dic.disease.endocrine,dic.disease.autoimmune,dic.disease.diabetes);
dic.disease.subs=["name"];
dic.disease.filters=["infectious","viral","std","bacterial","fever","mental","genetic","inflammatory","gi","poisoning","fungal","endocrine","autoimmune","diabetes"];
var element={};
dic.element=element;
dic.element.metal=["cesium/Cs","lithium/Li","potassium/K","rubidium/Rb","sodium/Na","barium/Ba","beryllium/Be","calcium/Ca","magnesium/Mg","strontium/Sr","cerium/Ce","dysprosium/Dy","erbium/Er","europium/Eu","gadolinium/Gd","holmium/Ho","lanthanum/La","lutetium/Lu","neodymium/Nd","praseodymium/Pr","promethium/Pm","samarium/Sm","terbium/Tb","thulium/Tm","ytterbium/Yb","aluminum/Al","bismusth/Bi","gallium/Ga","indium/In","lead/Pb","thallium/Tl","tin/Sn","actinium/Ac","americium/Am","berkelium/Bk","californium/Cf","curium/Cm","einsteinium/Es","fermium/Fm","lawrencium/Lr","mendelevium/Md","neptunium/Np","nobelium/No","plutonium/Pu","protactinium/Pa","thorium/Th","uranium/U","cadmium/Cd","chromium/Cr","cobalt/Co","copper/Cu","gold/Au","hafnium/Hf","iridium/Ir","iron/Fe","manganese/Mn","molybdenum/Mo","nickel/Ni","niobium/Nb","osmium/Os","palladium/Pd","platinum/Pt","rhenium/Re","rhodium/Rh","ruthenium/Ru","scandium/Sc","silver/Ag","tantalum/Ta","technetium/Tc","titanium/Ti","tungsten/W","vanadium/V","yttrium/Y","zinc/Zn","zircomium/Zr"];
dic.element.alkali=["cesium/Cs","lithium/Li","potassium/K","rubidium/Rb","sodium/Na"];
dic.element.radioactive=["francium/Fr","radium/Ra","actinium/Ac","americium/Am","berkelium/Bk","californium/Cf","curium/Cm","einsteinium/Es","fermium/Fm","lawrencium/Lr","mendelevium/Md","neptunium/Np","nobelium/No","plutonium/Pu","protactinium/Pa","thorium/Th","uranium/U","polonium/Po","radon/Rn","astatine/At"];
dic.element.alkaline_earth=["barium/Ba","beryllium/Be","calcium/Ca","magnesium/Mg","strontium/Sr"];
dic.element.earth=["barium/Ba","beryllium/Be","calcium/Ca","magnesium/Mg","strontium/Sr"];
dic.element.lanthanoid=["cerium/Ce","dysprosium/Dy","erbium/Er","europium/Eu","gadolinium/Gd","holmium/Ho","lanthanum/La","lutetium/Lu","neodymium/Nd","praseodymium/Pr","promethium/Pm","samarium/Sm","terbium/Tb","thulium/Tm","ytterbium/Yb"];
dic.element.post_transition=["aluminum/Al","bismusth/Bi","gallium/Ga","indium/In","lead/Pb","thallium/Tl","tin/Sn"];
dic.element.actinoid=["actinium/Ac","americium/Am","berkelium/Bk","californium/Cf","curium/Cm","einsteinium/Es","fermium/Fm","lawrencium/Lr","mendelevium/Md","neptunium/Np","nobelium/No","plutonium/Pu","protactinium/Pa","thorium/Th","uranium/U"];
dic.element.transition=["cadmium/Cd","chromium/Cr","cobalt/Co","copper/Cu","gold/Au","hafnium/Hf","iridium/Ir","iron/Fe","manganese/Mn","molybdenum/Mo","nickel/Ni","niobium/Nb","osmium/Os","palladium/Pd","platinum/Pt","rhenium/Re","rhodium/Rh","ruthenium/Ru","scandium/Sc","silver/Ag","tantalum/Ta","technetium/Tc","titanium/Ti","tungsten/W","vanadium/V","yttrium/Y","zinc/Zn","zircomium/Zr"];
dic.element.liquid=["mercury/Hg","bromine/Br"];
dic.element.metalloid=["antimony/Sb","arsenic/As","boron/B","germanium/Ge","silicon/Si","tellurium/Te"];
dic.element.halogen=["chlorine/Cl","fluorine/F","astatine/At","bromine/Br","iodine/I"];
dic.element.nonmetal=["hydrogen/H","nitrogen/N","oxygen/O","argon/Ar","helium/He","krypton/Kr","neon/Ne","xenon/Xe","carbon/C","phosphorus/P","selenium/Se","sulfur/S"];
dic.element.gas=["hydrogen/H","nitrogen/N","oxygen/O","argon/Ar","helium/He","krypton/Kr","neon/Ne","xenon/Xe"];
dic.element.diatomic=["hydrogen/H","nitrogen/N","oxygen/O","astatine/At","bromine/Br","iodine/I"];
dic.element.noble_gas=["argon/Ar","helium/He","krypton/Kr","neon/Ne","xenon/Xe"];
dic.element.polyatomic=["carbon/C","phosphorus/P","selenium/Se","sulfur/S"];
dic.element.all=[].concat(dic.element.metal,dic.element.alkali,dic.element.radioactive,dic.element.alkaline_earth,dic.element.earth,dic.element.lanthanoid,dic.element.post_transition,dic.element.actinoid,dic.element.transition,dic.element.liquid,dic.element.metalloid,dic.element.halogen,dic.element.nonmetal,dic.element.gas,dic.element.diatomic,dic.element.noble_gas,dic.element.polyatomic);
dic.element.subs=["name","symbol"];
dic.element.filters=["metal","alkali","radioactive","alkaline_earth","earth","lanthanoid","post_transition","actinoid","transition","liquid","metalloid","halogen","nonmetal","gas","diatomic","noble_gas","polyatomic"];
var em={};
dic.em=em;
...
dic.noun.round=["golf ball/golf balls","kidney/kidneys"];
...
var state={};
dic.state=state;
dic.state.usa=["Alabama/AL","Alaska/AK","Arizona/AZ","Arkansas/AR","California/CA","Colorado/CO","Connecticut/CT","Delaware/DE","Florida/FL","Georgia/GA","Hawaii/HI","Idaho/ID","Illinois/IL","Indiana/IN","Iowa/IA","Kansas/KS","Kentucky/KY","Louisiana/LA","Maine/ME","Maryland/MD","Massachusetts/MA","Michigan/MI","Minnesota/MN","Mississippi/MS","Missouri/MO","Montana/MT","Nebraska/NE","Nevada/NV","New Hampshire/MH","New Jersey/NJ","New Mexico/NM","New York/NY","North Carolina/NC","North Dakota/ND","Ohio/OH","Oklahoma/OK","Oregon/OR","Pennsylvania/PA","Rhode Island/RI","South Carolina/SC","South Dakota/SD","Tennessee/TN","Texas/TX","Utah/UT","Vermont/VT","Virginia/VA","Washington/WA","West Virginia/WV","Wisconsin/WI","Wyoming/WY"];
dic.state.germany=["Baden-Württemberg/BW","Bavaria/BY","Berlin/BE","Brandenburg/BB","Bremen/HB","Hamburg/HH","Hesse/HE","Lower Saxony/NI","Mecklenburg-Vorpommern/MV","North Rhine-Westphalia/NW","Rhineland-Palatinate/RP","Saarland/SL","Saxony/SN","Saxony-Anhalt/ST","Schleswig-Holstein/SH","Thuringia/TH"];
dic.state.all=[].concat(dic.state.usa,dic.state.germany);
dic.state.subs=["name","abbr"];
dic.state.filters=["usa","germany"];
var substance={};
dic.substance=substance;
dic.substance.liquid=["acid","beer","blood","earwax","extra-virgin olive oil","gasoline","grease","ink","ketchup","lava","lemonade","liquid nitrogen","magma","mayonnaise","molten iron","mustard","oil","olive oil","orange juice","paint","plasma","sap","soy sauce","sweat","tears","tomato sauce","vinegar","vodka","vomit","water","wine"];
...
dic.verb.move=["push/pushing/pushed/pushes/pusher/pushed/pushing"];
...
},{"./braceParser":1,"./capitalize":2,"./getCase":4,"./lexer":6}],6:[function(require,module,exports){
...
},{"./en_US":3,"./replaceToken":8}],7:[function(require,module,exports){
