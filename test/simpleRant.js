...
dic.substance.all=["sand","earwax","oatmeal","spaghetti","flour","dark matter","antimatter","corn","snow","happiness","dick cheese"].concat(dic.substance.liquid);
dic.substance.subs=["default"];
dic.substance.filters=["liquid"];
var surname={};
dic.surname=surname;
