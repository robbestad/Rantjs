...
var dic_pron=[];
var dic_pron_female = ["her/she/herself/her/hers"];
var dic_pron_male = ["him/he/himself/his/his", "male"];
dic_pron = dic_pron.concat(dic_pron_female,dic_pron_male);
var dic_quality=[];
...
var dic_timeadv=["5 minutes later","1 hour later","1 day later","1 week later","1 month later","6 months later","5 years later","10 years later"];
var dic_timeadv_frequency = ["once again", "frequency", "never again", "frequency", "instantly", "frequency", "usually", "frequency", "yesterday", "frequency", "sometimes", "frequency", "occasionally", "frequency", "often", "frequency", "once in a while", "frequency", "never", "frequency", "frequently", "frequency", "once a week", "frequency", "daily", "frequency", "once a month", "frequency", "again", "frequency", "repeatedly", "frequency", "all the time", "frequency", "hardly", "frequency", "barely", "frequency", "several times", "frequency", "every night", "frequency", "this time", "frequency", "biweekly", "frequency", "centenially", "frequency", "every now and then", "frequency", "from now on", "frequency", "until further notice", "frequency", "for 10 weeks", "frequency", "for 36 hours", "frequency", "on Mondays", "frequency", "every Tuesday", "frequency", "profusely", "frequency", "perpetually"];
var dic_timeadv_time = ["at sunrise", "time", "a month ago", "time past", "a week ago", "time past", "a day ago", "time past", "an hour ago", "time past", "a year ago", "time past", "millions of years ago", "time past", "billions of years ago", "time past", "trillions of years ago", "time past", "today", "time present", "tonight", "time present", "presently", "time present", "now", "time present", "just 5 minutes ago", "time past", "5 minutes later", "time", "1 hour later", "time", "1 day later", "time", "1 week later", "time", "1 month later", "time", "6 months later", "time", "a year later", "time", "5 years later", "time", "10 years later", "time", "at the full moon", "time", "at sunset", "time", "later", "time", "recently", "time"];
var dic_timeadv_past = ["a month ago", "time past", "a week ago", "time past", "a day ago", "time past", "an hour ago", "time past", "a year ago", "time past", "millions of years ago", "time past", "billions of years ago", "time past", "trillions of years ago", "time past", "just 5 minutes ago", "time past"];
var dic_timeadv_present = ["today", "time present", "tonight", "time present", "presently", "time present", "now", "time present"];
dic_timeadv = dic_timeadv.concat(dic_timeadv_frequency,dic_timeadv_time,dic_timeadv_past,dic_timeadv_present);
var dic_timenoun=[];
var dic_timenoun_holiday = ["New Year's Eve/New Year's Eves", "holiday", "New Year's Day/New Year's Days", "holiday", "Valentine's Day/Valentine's Days", "holiday", "Easter/Easters", "holiday", "Labor Day/Labor Days", "holiday", "Halloween/Halloweens", "holiday", "Thanksgiving/Thanksgivings", "holiday", "Christmas/Christmasses", "holiday", "Hanukkah/Hanukkahs", "holiday", "Black Friday/Black Fridays", "holiday", "Kwanzaa/Kwanzaas", "holiday", "Boxing Day/Boxing Days", "holiday", "Labor Day/Labor Days", "holiday", "Father's Day/Father's Days", "holiday", "Mother's Day/Mother's Days", "holiday", "Groundhog Day/Groundhog Days", "holiday"];
var dic_timenoun_unit = ["millisecond/milliseconds", "unit", "second/seconds", "unit", "minute/minutes", "unit", "hour/hours", "unit", "day/days", "unit", "month/months", "unit", "year/years", "unit", "century/centuries"];
var dic_timenoun_month = ["January/Januaries", "month", "February/Februaries", "month", "March/Marches", "month", "April/Aprils", "month", "May/Mays", "month", "June/Junes", "month", "July/Julies", "month", "August/Augusts", "month", "September/Septembers", "month", "October/Octobers", "month", "November/Novembers", "month", "December/Decembers", "month"];
var dic_timenoun_dayofweek = ["Sunday/Sundays", "dayofweek", "Monday/Mondays", "dayofweek", "Tuesday/Tuesdays", "dayofweek", "Wednesday/Wednesdays", "dayofweek", "Thursday/Thursdays", "dayofweek", "Friday/Fridays", "dayofweek", "Saturday/Saturdays", "dayofweek"];
var dic_timenoun_timeofday = ["dawn/dawns", "timeofday", "morning/mornings", "timeofday", "noon/noons", "timeofday", "day/days", "timeofday", "afternoon/afternoons", "timeofday", "evening/evenings", "timeofday", "dusk/dusks", "timeofday", "night/nights", "timeofday", "midnight/midnights", "timeofday"];
...
dic_unit = dic_unit.concat(dic_unit_energy,dic_unit_small,dic_unit_pressure,dic_unit_volume,dic_unit_potential,dic_unit_factor,dic_unit_large,dic_unit_length,dic_unit_power,dic_unit_current,dic_unit_weight,dic_unit_capacitance,dic_unit_inductance);var subs={}; var filters={};
